...
compatibility: Codex, Cursor, Windsurf, Kiro, GitHub Copilot, Roo Code, KiloCode
---
...
# Extract to your project's .Codex/skills/ui-ux-pro-max/
```
...
Codex reads your design system and implements with consistency.
...
- **Marketplace:** Codex plugin marketplace
...
**Install:** Via Codex marketplace or manual
